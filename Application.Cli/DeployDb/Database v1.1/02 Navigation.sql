...
(
    SELECT Navigation.Id, Navigation.ParentId, Navigation.Name, 0 AS Level, CAST(Name as NVARCHAR(1024)) AS Path FROM Demo.Navigation Navigation WHERE ParentId IS NULL
    UNION ALL
