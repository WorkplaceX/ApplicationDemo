    ...
    public static class RoadmapModuleBuiltInTableApplicationCli
    {
        public static List<RoadmapModuleBuiltIn> RowList
        {
            get
            {
                ...
                result.Add(new RoadmapModuleBuiltIn() { Id = 5, IdName = "ApplicationCms", Name = "ApplicationCms", Text = "Application / Cms", Description = null, IsBuiltIn = true, IsExist = true });
