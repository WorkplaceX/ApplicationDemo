    ...
    public static class RoadmapBuiltInTableApplicationCli
    {
        public static List<RoadmapBuiltIn> RowList
        {
            get
            {
                ...
                result.Add(new RoadmapBuiltIn() { Id = 3, Name = Guid.Parse("da61059f-e91b-4379-bb13-f69731a2ea4c"), Description = "Upload image (Framework image database table)", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 2, RoadmapPriorityIdName = "Medium", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                ...
                result.Add(new RoadmapBuiltIn() { Id = 6, Name = Guid.Parse("27e60a75-cfa5-420b-b316-093b1feef57f"), Description = "Dropdown annotation", Date = null, RoadmapCategoryId = 3, RoadmapCategoryIdName = "Analyze", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 7, Name = Guid.Parse("607f4e9d-f178-4922-bc4f-1d12ed9e26f2"), Description = "Roadmap date", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 5, RoadmapModuleIdName = "ApplicationRoadmap", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 4, RoadmapStateIdName = "Done", IsBuiltIn = true, IsExist = true });
