    ...
    public static class FrameworkConfigFieldBuiltInTableApplicationCli
    {
        public static List<FrameworkConfigFieldBuiltIn> RowList
        {
            get
            {
                ...
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 36, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 290, FieldIdName = "Demo.RoadmapDisplay; LoginUserText", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "LoginUserText", Text = "User", Description = null, IsVisible = null, IsReadOnly = null, Sort = null, IsExist = true });
                ...
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 38, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 283, FieldIdName = "Demo.RoadmapDisplay; RoadmapCategoryIdName", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "RoadmapCategoryIdName", Text = null, Description = null, IsVisible = false, IsReadOnly = null, Sort = null, IsExist = true });
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 39, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 282, FieldIdName = "Demo.RoadmapDisplay; RoadmapCategoryText", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "RoadmapCategoryText", Text = "Category", Description = null, IsVisible = null, IsReadOnly = null, Sort = null, IsExist = true });
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 40, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 285, FieldIdName = "Demo.RoadmapDisplay; RoadmapModuleText", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "RoadmapModuleText", Text = "Module", Description = null, IsVisible = null, IsReadOnly = null, Sort = null, IsExist = true });
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 41, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 288, FieldIdName = "Demo.RoadmapDisplay; RoadmapPriorityIdName", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "RoadmapPriorityIdName", Text = null, Description = null, IsVisible = false, IsReadOnly = null, Sort = null, IsExist = true });
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 42, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 287, FieldIdName = "Demo.RoadmapDisplay; RoadmapPriorityText", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "RoadmapPriorityText", Text = "Priority", Description = null, IsVisible = null, IsReadOnly = null, Sort = null, IsExist = true });
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 44, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 336, FieldIdName = "Demo.RoadmapDisplay; RoadmapStateIdName", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "RoadmapStateIdName", Text = null, Description = null, IsVisible = false, IsReadOnly = null, Sort = null, IsExist = true });
                result.Add(new FrameworkConfigFieldBuiltIn() { Id = 43, ConfigGridId = 8, ConfigGridIdName = "Demo.RoadmapDisplay; ", FieldId = 292, FieldIdName = "Demo.RoadmapDisplay; RoadmapStateText", InstanceName = null, TableNameCSharp = "Demo.RoadmapDisplay", ConfigName = null, FieldNameCSharp = "RoadmapStateText", Text = "State", Description = null, IsVisible = null, IsReadOnly = null, Sort = null, IsExist = true });
                return result;
            }
        }
    }
    ...
    public static class RoadmapModuleBuiltInTableApplicationCli
    {
        public static List<RoadmapModuleBuiltIn> RowList
        {
            get
            {
                ...
                result.Add(new RoadmapModuleBuiltIn() { Id = 4, IdName = "ApplicationLogin", Name = "ApplicationLogin", Text = "Application / Login", Description = null, IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapModuleBuiltIn() { Id = 5, IdName = "ApplicationRoadmap", Name = "ApplicationRoadmap", Text = "Application / Roadmap", Description = null, IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapModuleBuiltIn() { Id = 6, IdName = "ApplicationCms", Name = "ApplicationCms", Text = "Application / Cms", Description = null, IsBuiltIn = true, IsExist = true });
                return result;
            }
        }
    }
    ...
    public static class RoadmapBuiltInTableApplicationCli
    {
        public static List<RoadmapBuiltIn> RowList
        {
            get
            {
                ...
                result.Add(new RoadmapBuiltIn() { Id = 1, Name = Guid.Parse("c6e421fa-8f78-424d-9e0f-64da942e740f"), Description = "Method Data.Update(); if two users modified same record.", Date = null, RoadmapCategoryId = 2, RoadmapCategoryIdName = "Bug", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 2, Name = Guid.Parse("0acc2649-e499-4c3d-a329-7e6282747973"), Description = "Cell multiline", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 3, Name = Guid.Parse("da61059f-e91b-4379-bb13-f69731a2ea4c"), Description = "Upload image (Framework image database table)", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 4, Name = Guid.Parse("ba7a91fe-8a09-45ab-a3f5-a4f94bceb86d"), Description = "Roadmap priority color annotation", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 5, RoadmapModuleIdName = "ApplicationRoadmap", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 4, RoadmapStateIdName = "Done", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 5, Name = Guid.Parse("4ef7e1d7-eeb3-4cf0-bbb5-cd52428c9caa"), Description = "Lookup do not select first row", Date = null, RoadmapCategoryId = 2, RoadmapCategoryIdName = "Bug", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 2, RoadmapStateIdName = "Open", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 6, Name = Guid.Parse("27e60a75-cfa5-420b-b316-093b1feef57f"), Description = "Lookup data grid annotation", Date = null, RoadmapCategoryId = 3, RoadmapCategoryIdName = "Analyze", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 7, Name = Guid.Parse("607f4e9d-f178-4922-bc4f-1d12ed9e26f2"), Description = "Roadmap date column", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 5, RoadmapModuleIdName = "ApplicationRoadmap", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 4, RoadmapStateIdName = "Done", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 8, Name = Guid.Parse("f562829c-d023-4ba7-99fc-65361c887c65"), Description = "Roadmap done annotation with check", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 5, RoadmapModuleIdName = "ApplicationRoadmap", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 4, RoadmapStateIdName = "Done", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 9, Name = Guid.Parse("18f7de7a-c22d-40f6-989e-79604b0bced6"), Description = "Cli command generate for Date", Date = null, RoadmapCategoryId = 2, RoadmapCategoryIdName = "Bug", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 4, RoadmapPriorityIdName = "Critical", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 10, Name = Guid.Parse("d7e1f5cd-648b-4c18-8fe9-2b95bd474ae9"), Description = "Excel import", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 11, Name = Guid.Parse("0b61b5bd-0405-4512-af42-b7d5a5eb104a"), Description = "Setting class", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 12, Name = Guid.Parse("1412dfe5-6d8e-42c9-8576-72d5e18618f2"), Description = "Calendar with holidays", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 2, RoadmapModuleIdName = "Application", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 13, Name = Guid.Parse("f45a2a50-3933-452c-9195-dfb21d5b02bc"), Description = "AppDoc CMS", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 2, RoadmapPriorityIdName = "Medium", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 14, Name = Guid.Parse("16e14652-e075-4759-938c-0e9ebe736928"), Description = "Show alert loading during server side render", Date = null, RoadmapCategoryId = 3, RoadmapCategoryIdName = "Analyze", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 15, Name = Guid.Parse("2b51d3f1-078d-4f37-aad4-9e9b7c4fa08b"), Description = "User sign up (register)", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 4, RoadmapModuleIdName = "ApplicationLogin", RoadmapPriorityId = 2, RoadmapPriorityIdName = "Medium", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 16, Name = Guid.Parse("23514dee-f766-42a3-8cf6-c5b828fb09fe"), Description = "User profile", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 4, RoadmapModuleIdName = "ApplicationLogin", RoadmapPriorityId = 2, RoadmapPriorityIdName = "Medium", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 17, Name = Guid.Parse("35e50249-67ae-49bb-91b3-c77ff53909ce"), Description = "Roadmap annotation for Framework (Chip) and Application (Tablet)", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 5, RoadmapModuleIdName = "ApplicationRoadmap", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 18, Name = Guid.Parse("0680161a-d0df-4b3a-9ad0-8c402ea97945"), Description = "Roadmap add number", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 5, RoadmapModuleIdName = "ApplicationRoadmap", RoadmapPriorityId = 2, RoadmapPriorityIdName = "Medium", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 19, Name = Guid.Parse("cd93b089-87d0-4ec0-9ce1-d17d431b335e"), Description = "Html Snippet", Date = null, RoadmapCategoryId = 3, RoadmapCategoryIdName = "Analyze", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 20, Name = Guid.Parse("b8db4e1a-97c8-4044-b514-e15576bf46d4"), Description = "Lookup window on same data row (for example roadmap)", Date = null, RoadmapCategoryId = 2, RoadmapCategoryIdName = "Bug", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 4, RoadmapPriorityIdName = "Critical", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 21, Name = Guid.Parse("60d25167-d113-42a5-89f9-62d83850a032"), Description = "Update Angular 9", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 22, Name = Guid.Parse("9e392c19-56c4-4008-8481-8426765068d9"), Description = "Update annotation for whole data row after user text modify", Date = null, RoadmapCategoryId = 2, RoadmapCategoryIdName = "Bug", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 23, Name = Guid.Parse("b9af7ea7-51b1-4613-b9d8-7c28b8fe617a"), Description = "Data grid with tab scroll to next column", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 24, Name = Guid.Parse("860bb46c-385c-45d2-8a6f-52774dac5414"), Description = "Detect browser css grid support on startup", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 25, Name = Guid.Parse("79585835-ac66-43dc-a04d-df4b955d98e6"), Description = "Google code prettify", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 6, RoadmapModuleIdName = "ApplicationCms", RoadmapPriorityId = 1, RoadmapPriorityIdName = "Low", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                return result;
            }
        }
    }
