    ...
    public static class RoadmapBuiltInTableApplicationCli
    {
        public static List<RoadmapBuiltIn> RowList
        {
            get
            {
                ...
                result.Add(new RoadmapBuiltIn() { Id = 3, Name = Guid.Parse("da61059f-e91b-4379-bb13-f69731a2ea4c"), Description = "Upload image", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 2, RoadmapPriorityIdName = "Medium", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 1, RoadmapStateIdName = "New", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 4, Name = Guid.Parse("ba7a91fe-8a09-45ab-a3f5-a4f94bceb86d"), Description = "Roadmap priority color annotation", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 2, RoadmapModuleIdName = "Application", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 4, RoadmapStateIdName = "Done", IsBuiltIn = true, IsExist = true });
                ...
                result.Add(new RoadmapBuiltIn() { Id = 7, Name = Guid.Parse("607f4e9d-f178-4922-bc4f-1d12ed9e26f2"), Description = "Roadmap date", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 2, RoadmapModuleIdName = "Application", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 4, RoadmapStateIdName = "Done", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 8, Name = Guid.Parse("f562829c-d023-4ba7-99fc-65361c887c65"), Description = "Roadmap done annotation with check", Date = null, RoadmapCategoryId = 1, RoadmapCategoryIdName = "Feature", RoadmapModuleId = 2, RoadmapModuleIdName = "Application", RoadmapPriorityId = 3, RoadmapPriorityIdName = "High", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = 4, RoadmapStateIdName = "Done", IsBuiltIn = true, IsExist = true });
                result.Add(new RoadmapBuiltIn() { Id = 9, Name = Guid.Parse("18f7de7a-c22d-40f6-989e-79604b0bced6"), Description = "Cli command generate for Date", Date = null, RoadmapCategoryId = 2, RoadmapCategoryIdName = "Bug", RoadmapModuleId = 1, RoadmapModuleIdName = "Framework", RoadmapPriorityId = 4, RoadmapPriorityIdName = "Critical", LoginUserId = 5, LoginUserIdName = "Developer", RoadmapStateId = null, RoadmapStateIdName = null, IsBuiltIn = true, IsExist = true });
                return result;
            }
        }
    }
