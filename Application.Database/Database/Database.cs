...
namespace Database.Demo
{
    ...
    [SqlTable("Demo", "CmsCodeBlockType")]
    public class CmsCodeBlockType : Row
    {
    ...
    public class CmsComponent : Row
    {
        ...
        [SqlField("PagePath", FrameworkTypeEnum.Nvarcahr)]
    ...
    public class CmsComponentDisplay : Row
    {
        [SqlField("Id", FrameworkTypeEnum.Int)]
        public int Id { get; set; }
        ...
        [SqlField("ParentPagePath", FrameworkTypeEnum.Nvarcahr)]
    ...
    public class CmsComponentType : Row
    {
        [SqlField("Id", true, FrameworkTypeEnum.Int)]
        public int Id { get; set; }
